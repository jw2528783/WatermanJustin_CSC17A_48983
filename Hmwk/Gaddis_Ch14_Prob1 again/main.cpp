            ...
            if(number>999){
                if((number/100)%10==0){
                    if((number-((number/100)*100))<20){
                        ...
                        cout<<less20[(number-((number/1000)*1000))]<<endl;
                    }
                    else{
                        cout<<less20[number/1000]<<" "<<thousand<<" ";
                        cout<<less100[(number-((number/100)*100))/10]<<" ";
                        cout<<less20[(number-((number/100)*100))%10]<<endl;
                    }
                }
                else if((number-((number/100)*100))<20){
                    cout<<less20[number/1000]<<" "<<thousand<<" ";
                    cout<<less20[(number/100)%10]<<" "<<hundred<<" ";
                    cout<<less20[(number-((number/100)*100))]<<endl;
                }
                else{
                    cout<<less20[number/1000]<<" "<<thousand<<" ";
                    cout<<less20[(number/100)%10]<<" "<<hundred<<" ";
                ...
                if((number-((number/100)*100))<20){
                    cout<<less20[number/100]<<" "<<hundred<<" ";
                    cout<<less20[(number-((number/100)*100))]<<endl;
                }
                else{
                    cout<<less20[number/100]<<" "<<hundred<<" ";
